...
@section('content')
    <div class="w-full max-w-xl m-auto">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 m-8" enctype="multipart/form-data" method="post" action={{ route('admin.series.store') }}>
            @csrf
            <div class="text-center">
                <p class="text-2xl font-lato ">Add Series</p>
            </div>
            <div class="mb-4">
